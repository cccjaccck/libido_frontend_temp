...
const DockWrapper = styled.div`
    ...
    position: fixed;
    left: 0;
    bottom: ${ props => props.showUp ? '0' : '-52px' };
...
const GradientShadow = styled.div`
    ...
    height: 100%;
    position: absolute;
    background: linear-gradient(to top, rgba(255, 255, 255, .97) 40%, transparent);
    bottom: 30px;
    text-align: center;
    svg {
        width: 24px;
...
const Container = styled.div`
    ...
    box-shadow: 0 -2px 6px rgba(36, 15, 57, .09);
    position: relative;
`;
